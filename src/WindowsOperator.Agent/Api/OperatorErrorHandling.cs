...
public static class OperatorErrorHandling
{
    public static IApplicationBuilder UseOperatorErrorHandling(this IApplicationBuilder app) =>
        app.Use(async (context, next) =>
        {
            ...
            catch (OperatorFailureException failure)
            {
                await WriteErrorAsync(
                    context,
                    failure.Error,
                    OperatorHttp.MapStatusCode(failure.Error.Code));
            }
            ...
            catch (Exception exception)
            {
                var logger = context.RequestServices
                    ...
                    .CreateLogger("WindowsOperator.Agent.Api");
                logger.LogError(
                    exception,
