...
public static class HostOperatorHttp
{
    ...
    public static int MapStatusCode(string errorCode) =>
        errorCode switch
        {
            ...
            ErrorCodes.OneDriveUnavailable => StatusCodes.Status423Locked,
            ErrorCodes.OneDriveRootNotFound => StatusCodes.Status404NotFound,
            ErrorCodes.OneDriveFileNotFound => StatusCodes.Status404NotFound,
            ErrorCodes.OneDriveLeaseNotFound => StatusCodes.Status404NotFound,
            ErrorCodes.OneDriveReclaimNotFound => StatusCodes.Status404NotFound,
            ErrorCodes.OneDrivePathBlocked => StatusCodes.Status422UnprocessableEntity,
            ErrorCodes.OneDrivePolicyDenied => StatusCodes.Status403Forbidden,
            ErrorCodes.OneDriveIdempotencyConflict => StatusCodes.Status409Conflict,
            ErrorCodes.OneDriveConfigConflict => StatusCodes.Status409Conflict,
            ErrorCodes.OneDriveLeaseConflict => StatusCodes.Status409Conflict,
            ErrorCodes.OneDriveContentChanged => StatusCodes.Status409Conflict,
            ErrorCodes.OneDriveHydrationTimeout => StatusCodes.Status504GatewayTimeout,
            ErrorCodes.OneDriveDehydrationTimeout => StatusCodes.Status504GatewayTimeout,
            ErrorCodes.OneDriveHydrationFailed => StatusCodes.Status423Locked,
            ErrorCodes.OneDriveDehydrationFailed => StatusCodes.Status409Conflict,
            ErrorCodes.OneDriveVerificationFailed => StatusCodes.Status409Conflict,
